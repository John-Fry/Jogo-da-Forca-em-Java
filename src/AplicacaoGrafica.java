...
public class AplicacaoGrafica {
	...
	private void initialize() {
		...
		label_4.setBounds(8, 72, 60, 14);
		frame.getContentPane().add(label_4);

		textField = new JTextField();
		textField.setBounds(55, 69, 35, 20);
		...
		button_1.setBounds(100, 68, 104, 23);
		...
		label_1.setBounds(144, 17, 80, 16);
	...
	public void exibirImagem(String arquivo) {
		ImageIcon icon = new ImageIcon(Objects.requireNonNull(this.getClass().getResource("/imagens/" + arquivo)));
